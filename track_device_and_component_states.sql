...
ALTER TABLE "device_states" ADD FOREIGN KEY ("identifier") REFERENCES "device_installations" ("device_identifier");

ALTER TABLE "device_installations" ADD FOREIGN KEY ("installation_id") REFERENCES "installations" ("id");

ALTER TABLE "device_states" ADD FOREIGN KEY ("device_type_id") REFERENCES "device_types" ("id");
...
ALTER TABLE "component_types" ADD FOREIGN KEY ("id") REFERENCES "component_states" ("component_type_id");

ALTER TABLE "component_states" ADD FOREIGN KEY ("device_identifier") REFERENCES "device_states" ("identifier");
